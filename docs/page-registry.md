...
|---|---|---|---|
| https://wknd.site/ | / | complete, deployed, real content, visually matched to reference | P:93-94 A:100 BP:100 SEO:69* |
| https://wknd.site/us/en/magazine.html | /magazine/ | complete, deployed, real content, visually matched to reference | P:94 A:100 BP:100 SEO:69* |
| https://wknd.site/us/en/magazine/western-australia.html | /magazine/western-australia | complete, deployed, real content, visually matched to reference | P:94 A:100 BP:100 SEO:69* |
...
| https://wknd.site/us/en/adventures.html | /adventures/ | complete, deployed, real content, visually matched to reference | P:94 A:100 BP:100 SEO:69* |
...
| https://wknd.site/us/en/adventures/bali-surf-camp.html | /adventures/bali-surf-camp | complete, deployed, real content, visually matched to reference | P:94 A:100 BP:100 SEO:69* |
...
| https://wknd.site/us/en/faqs.html | /faqs | complete, deployed, real content, visually matched to reference | P:94 A:100 BP:100 SEO:69* |
| https://wknd.site/us/en/about-us.html | /about-us | complete, deployed, real content, visually matched to reference | P:94 A:100 BP:100 SEO:69* |
...
- **Lighthouse CLS noise**: one measurement run showed a spurious CLS regression on two pages when testing against the live CDN over a real network; re-running the exact same audit immediately after returned a perfect score. Treated as lab-data network variance, not a real defect. The same was seen with a one-off performance dip to 71 on `/` in one run; a re-run returned to 93.
- **Visual redesign pass** (this project initially shipped with invented placeholder colors/type/layout, later corrected against the reference's real computed styles — see `docs/component-registry.md`'s "Real design tokens" section): fixed heading sizes that incorrectly scaled up at wider breakpoints (reference is fixed-size at every width), card title/description sizes and the "Featured Article" eyebrow style, dropped an unconfirmed `cards.list` single-column variant once measurement showed both listing pages actually use the same 4-column grid, added the hero's real overlap-card treatment at ≥768px, fixed a hero carousel dot touch-target-size a11y failure, and fixed a FAQ page heading-order failure (h1→h3 skip) by promoting "Need more help?" to h2 — this one is a deliberate deviation from the reference, which has the same skip uncorrected.
